...
namespace Demo8_Coordinate_Systems_NSP
{
	...
	void Demo::Init()
	{
		...
		// ------------------------------------
		// 建立 Shader Program
		shaderProgramPtr = std::make_unique<Shader>("shader_code/demo8_coordinate_systems_camera.vs", "shader_code/demo8_coordinate_systems_camera.fs");
	...
	void Demo::Render()
	{
		...
		shaderProgramPtr->setMat4("projection", projection);
